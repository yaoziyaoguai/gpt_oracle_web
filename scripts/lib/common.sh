...
readonly ORACLE_WEB_DA31C46_UPGRADE_PATCH="$ORACLE_WEB_REPO_ROOT/patches/oracle-0.17.3-from-da31c46.patch"
readonly ORACLE_WEB_DA31C46_HASH_MANIFEST="$ORACLE_WEB_REPO_ROOT/patches/oracle-0.17.3-da31c46.sha256"
readonly ORACLE_WEB_DA31C46_NPM_HASH_MANIFEST="$ORACLE_WEB_REPO_ROOT/patches/oracle-0.17.3-da31c46-npm.sha256"
readonly ORACLE_WEB_E13EA4C_UPGRADE_PATCH="$ORACLE_WEB_REPO_ROOT/patches/oracle-0.17.3-from-e13ea4c.patch"
readonly ORACLE_WEB_E13EA4C_HASH_MANIFEST="$ORACLE_WEB_REPO_ROOT/patches/oracle-0.17.3-e13ea4c.sha256"
readonly ORACLE_WEB_E13EA4C_NPM_HASH_MANIFEST="$ORACLE_WEB_REPO_ROOT/patches/oracle-0.17.3-e13ea4c-npm.sha256"
